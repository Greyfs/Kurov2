...
if (anu.action == 'add') {
    ...
    xeonbody = `@${xeonName.split("@")[0]} Halooo`;
    XeonBotInc.sendMessage(anu.id, { text: xeonbody });
    ...
    xeonbody = `@${xeonName.split("@")[0]} Byeee`;
    XeonBotInc.sendMessage(anu.id, { text: xeonbody });
    ...
    const xeondate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY');
    let xeonName = num;
    xeonbody = ` 🦍🐀🎉 @${xeonName.split("@")[0]}, you have been *promoted* to *admin* 🥳`;
    XeonBotInc.sendMessage(anu.id, { text: xeonbody });
    ...
    const xeondate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY');
    let xeonName = num;
    xeonbody = `Yeah @${xeonName.split("@")[0]}, you have been *demoted* from *admin* 😬`;
    XeonBotInc.sendMessage(anu.id, { text: xeonbody });
}
}
} catch (err) {
